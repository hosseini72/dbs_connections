...
class TestMongoPoolConfig(unittest.TestCase):
    ...
    def test_default_values(self):
        ...
        config = MongoPoolConfig(host="localhost")
    ...
    def test_invalid_auth_mechanism(self):
        ...
        with self.assertRaisesRegex(ValueError, "Invalid auth_mechanism"):
            MongoPoolConfig(host="localhost", auth_mechanism="INVALID")
    ...
    def test_valid_auth_mechanisms(self):
        ...
        for mechanism in valid_mechanisms:
            config = MongoPoolConfig(host="localhost", auth_mechanism=mechanism)
    ...
    def test_get_connection_params_no_auth(self):
        ...
        config = MongoPoolConfig(host="localhost", port=27017)
    ...
    def test_get_connection_string_with_ssl(self):
        ...
        config = MongoPoolConfig(host="cluster.mongodb.net", ssl=True, use_srv=True)
    ...
    def test_from_uri_with_additional_params(self):
        ...
        config = MongoPoolConfig.from_uri(uri, max_connections=20, min_connections=5)
    ...
    def test_read_preference(self):
        ...
        config = MongoPoolConfig(host="localhost", read_preference="secondaryPreferred")
    ...
    def test_write_concern(self):
        ...
        config = MongoPoolConfig(host="localhost", w=2, wtimeout=5000, journal=True)
    ...
    def test_read_concern(self):
        ...
        config = MongoPoolConfig(host="localhost", read_concern_level="majority")
    ...
    def test_retry_writes(self):
        ...
        config = MongoPoolConfig(host="localhost", retry_writes=True)
    ...
    def test_compressors(self):
        ...
        config = MongoPoolConfig(host="localhost", compressors=["snappy", "zlib"])
...
class TestMongoPoolConfigEdgeCases(unittest.TestCase):
    ...
    def test_special_characters_in_password(self):
        ...
        config = MongoPoolConfig(host="localhost", password="p@ssw0rd!#$%")
    ...
    def test_ipv6_host(self):
        ...
        config = MongoPoolConfig(host="::1", port=27017)

        self.assertEqual(config.host, "::1")

    def test_unix_socket_host(self):
        """Test Unix socket host."""
        config = MongoPoolConfig(host="/var/run/mongodb/mongodb.sock")
    ...
    def test_multiple_hosts(self):
        ...
        config = MongoPoolConfig(hosts=["host1:27017", "host2:27017", "host3:27017"])
    ...
    def test_server_selection_timeout(self):
        ...
        config = MongoPoolConfig(host="localhost", server_selection_timeout_ms=5000)
    ...
    def test_heartbeat_frequency(self):
        ...
        config = MongoPoolConfig(host="localhost", heartbeat_frequency_ms=10000)
