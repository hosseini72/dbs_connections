...
class Neo4jHealthChecker:
    ...
    def __init__(self, pool_or_config: Union["Neo4jSyncConnectionPool", "Neo4jAsyncConnectionPool", "Neo4jPoolConfig"]):
    ...
    def check_server_info(self, driver) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if not hasattr(driver, 'session') or not callable(getattr(driver, 'session', None)):
                return None
